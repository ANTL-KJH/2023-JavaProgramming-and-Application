package ch11_6_1_MySQL_JDBC_AcademicManagementSystem;
...
public class MySQL_JDBCS_AcademicManagementSystem {
    public static void main(String[] args) throws InstantiationException,
        ...
        int result;
        final String inputFileName = "tbl_students.txt";
        ...
        final String db_academic_name = "DB_ACADEMIC";
        final String user_name = "JHKIM";
        final String passwd = "antl3940";
        String sql = null;
        try {
            ...
            if (conn_db_academic != null) {
                ...
                sql = "CREATE DATABASE " + db_academic_name;
                result = stmt.executeUpdate(sql);
                System.out.printf("Database (DB_ACADEMIC) created successfully ....\n");
                String url_academicDB = "jdbc:mysql://localhost:3306/" + db_academic_name;
            ...
            if (tableExistsSQL(conn_db_academic, tbl_students_name)) {
                System.out.printf("Table (%s) is already existing in Database (%s)\n",
                        tbl_students_name, db_academic_name);
            } else {
            ...
            try {
                ...
                System.out.println("Duplicate entry Input!! Skip Insert");
            }
