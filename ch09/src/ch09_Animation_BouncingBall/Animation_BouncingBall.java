...
public class Animation_BouncingBall {
    ...
    public static void main(String[] args) {
        ...
        JPanel_BouncingBall jp_bouncingBall = new
                JPanel_BouncingBall(ball_diameter, fr_width, fr_height,
        ...
        JSlider_SpeedControl jslider_SpeedControl = new
                JSlider_SpeedControl(jp_bouncingBall, fr_width, fr_height,
                fr_x_margin, fr_y_margin, border_thickness);
        ...
        jf.setSize(fr_width + fr_x_margin + border_thickness,
                fr_height + fr_y_colorControl + fr_y_speedControl +
